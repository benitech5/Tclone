...
function CustomDrawerContent(props: any) {
  ...
  const handleAddAccount = () => {
    ...
    setTimeout(() => {
      ...
      rootNav.navigate("Confirmation", {
        message:
          "Do you want to add a new account? You will be taken to onboarding and your previous account will not be saved.",
        action: "addAccount",
      });
    }, 300);
  };
  ...
  return (
    <View style={{ flex: 1 }}>
      {showWelcome && (
        <View
          style={{
            backgroundColor: theme.mode === "dark" ? "#2a2d3a" : "#e0f7fa",
            padding: 10,
          }}
        >
          <Text
