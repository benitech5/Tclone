      ...
      >
        ...
        <View style={styles.row}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.folderDesc, { color: theme.subtext }]}>
              New messages from all chats.
            </Text>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.row}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.folderDesc, { color: theme.subtext }]}>
              Only messages from personal chats.
            </Text>
          </View>
          <TouchableOpacity
            style={[styles.addButton, { backgroundColor: theme.accent }]}
        ...
        <View style={styles.row}>
          <MaterialIcons
            ...
            style={styles.icon}
          />
          <Text style={[styles.folderTitle, { color: theme.text, flex: 1 }]}>
            All Chats
          </Text>
        </View>
        ...
        <TouchableOpacity style={styles.row}>
          <Ionicons
            ...
            style={styles.icon}
          />
          <Text style={[styles.folderTitle, { color: theme.accent }]}>
            Create New Folder
          </Text>
        </TouchableOpacity>
        ...
        {/* Premium Note */}
        <Text style={[styles.premiumNote, { color: theme.subtext }]}>
          Subscribe to{" "}
          <Text
