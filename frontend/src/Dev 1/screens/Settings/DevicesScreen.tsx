...
const DevicesScreen = () => {
  ...
  // Force re-render for GIF animation
  const gifKey = React.useMemo(() => Date.now(), []);
    ...
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        <View style={{ alignItems: "center", marginVertical: 24 }}>
          <Image
            key={gifKey}
            source={require("../../../../assets/avatars/everything/Animated laptop.gif")}
            style={[
              styles.icon,
              styles.animatedIcon,
        ...
        <View style={styles.deviceRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.deviceDesc, { color: theme.subtext }]}>
              Orbixa Android 11.12.0{"\n"}Kumasi, Ghana • online
            </Text>
          </View>
        </View>
        ...
        <Text style={[styles.terminateInfo, { color: theme.subtext }]}>
        ...
        <View style={styles.deviceRow}>
          <Image
            key={`${gifKey}-active`}
            source={require("../../../../assets/avatars/everything/Animated laptop.gif")}
            style={[styles.icon, styles.animatedIcon]}
            resizeMode="contain"
            fadeDuration={0}
          />
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.deviceDesc, { color: theme.subtext }]}>
              Orbixa Desktop 5.0.1 x64 Microsoft Store{"\n"}Kumasi, Ghana • Thu
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  terminateButtonText: { color: "#fff", fontWeight: "bold", fontSize: 15 },
